...
interface CrowdsalePostDeliveryMockInterface extends ethers.utils.Interface {
  functions: {
    "buyTokens(address,uint256)": FunctionFragment;
    "getBeneficiaryAmount(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getBeneficiaryAmount",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class CrowdsalePostDeliveryMock extends BaseContract {
  ...
  interface: CrowdsalePostDeliveryMockInterface;
