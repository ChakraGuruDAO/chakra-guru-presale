...
interface CrowdsaleBaseMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "preValidatePurchase(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getRaiseWallet",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "preValidatePurchase",
...
export class CrowdsaleBaseMock extends BaseContract {
  ...
  interface: CrowdsaleBaseMockInterface;
  ...
  functions: {
    ...
    getRaiseWallet(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getRaiseWallet(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getRaiseWallet(overrides?: CallOverrides): Promise<PopulatedTransaction>;
