...
interface CrowdsaleLimitterInterface extends ethers.utils.Interface {
  functions: {
...
export class CrowdsaleLimitter extends BaseContract {
  ...
  interface: CrowdsaleLimitterInterface;
